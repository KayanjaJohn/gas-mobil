...
export default function HomeScreen() {
  ...
  const getStatusColor = (p: number): string => p < 20 ? '#ff4d4d' : p < 50 ? '#f59e0b' : '#22c55e';
  ...
  const getStatusLabel = (p: number): string => p < 20 ? 'LOW' : p < 50 ? 'HALF' : 'FULL';
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.orderCard}>
          <View style={styles.orderText}>
            ...
            <Text style={styles.orderTitle}>Swap your empty cylinder for a full one</Text>
            <TouchableOpacity 
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.action} onPress={() => router.push('/order')}>
            <View style={[styles.actionIcon, { backgroundColor: 'rgba(20,132,255,.15)' }]}>
              <RefreshCw size={18} color="#3DA5FF" />
            </View>
            <Text style={styles.actionText}>Swap Refill</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.action} onPress={() => router.push('/order')}>
            <View style={[styles.actionIcon, { backgroundColor: 'rgba(255,77,77,.15)' }]}>
              <ShoppingBag size={18} color="#ff6b6b" />
            </View>
            <Text style={styles.actionText}>Buy New</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.action} onPress={() => router.push('/(tabs)/agents')}>
            <View style={[styles.actionIcon, { backgroundColor: 'rgba(34,197,94,.15)' }]}>
              <Map size={18} color="#3ddc84" />
            </View>
            <Text style={styles.actionText}>Find Agent</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.action} onPress={() => router.push('/(tabs)/accessories')}>
            <View style={[styles.actionIcon, { backgroundColor: 'rgba(245,158,11,.15)' }]}>
        ...
        <TouchableOpacity style={styles.stationCard} onPress={() => router.push('/(tabs)/agents')}>
        ...
        <View style={styles.contactCard}>
          <View style={styles.contactHead}>
            ...
            <View>
              ...
              <Text style={styles.contactSub}>
                A member of <Text style={styles.accent}>Lambula Creative Agency</Text>
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoList}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>Plot 12, Kampala Road, Kampala, Uganda</Text>
            </View>
            <View style={styles.infoItem}>
